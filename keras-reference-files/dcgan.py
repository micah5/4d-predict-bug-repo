...
def save_generated_images(generated_images, epoch, batch_number):
    ...
    for i in range(64):
        ...
        fig = plt.imshow(stacked_img.astype(np.uint8))
        plt.axis('off')
...
def train_dcgan(batch_size, epochs, image_shape, dataset_path):
    ...
    #print('dataset generator', dataset_generator.shape)

    # 2719 is the total number of images on the dataset
    number_of_batches = int(2000 / batch_size)
    ...
    for epoch in range(epochs):
        ...
        for batch_number in range(number_of_batches):
            ...
            print('real_images', real_images.shape, real_images.shape[0])
